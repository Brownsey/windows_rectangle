...
class DiagnosticReport:
    ...
    def to_text(self) -> str:
        ...
        lines.append(f"        {'present' if self.config_exists else 'will be created on first launch'}")
        lines.append("")
...
def collect_diagnostic_report(
    *,
    ...
    if config_path_factory is None:
        from .adapters.json_config import default_config_path as config_path_factory  # type: ignore[no-redef]
